...
os.wjejejdjdjdidjdzjxmxnxnxnxmxmxkxkxkkxk
djxjxjxjxjxjx
dkdkdd1000000000000000000000
pppppppppppppp
pppppppp()
        time.sleep(0.1)
...
back = 0
oks = []ppppppepfkckckckc

xmxmxmxmxmdmxmxmxmxmxmmxxmmxxm
id = []
cpb = []
vulnot = '\x1b[31mNot Vuln'
vuln = '\x1bxmxmxxmxnxmxmx[32mVuln'
os.system("clear")
##### LOGO #####
logo='''
...
(  ____ \(  ___  )(       )(  ____ \(  ____ )
| (    \/| (   ) || () () || (    \/| (    )|
| (_____ | (__djjdjdjdjdjdj_) || || || || (__    | (____)|
(_____  )|  ___  || |(_)| ||  __)   |     __)
      ) || (   ) || |   | || (      | (\ (   
/\____) || )   ( || )   ( || (____/\| ) \ \__
\_______)|/     \||/     \|(_______/|/   \__/
...
def menu():
    os.system('clear')
    print logo
    print '\x1b[1;97m[1]\x1b[1;97m  KURDSTAN'
    print '\x1b[1;97m[2]\x1b[1;97m  KURDSTAN'
    print '\n\x1b[1;97m[0]  Exit            '
    print '\x1b[1;97m--------------------------------------------------\n'
    action()
...
def action():
    ...
    if peak == '':
        ...
        print logo
        print '\x1b[1;97mArea Codes With Network' + '\n'
        print '\x1b[1;97m750,751,770,771' + '\n'
        try:
            c = raw_input('\x1b[1;97mChoose Area Code : ')
            k = '+964'
            idlist = '.txt'
